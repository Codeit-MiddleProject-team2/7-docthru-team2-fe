      ...
      <div className={styles.home}>
        <div className={styles.section}>
          <div className={styles.content}>
            ...
            <div className={styles.title}>
              혼자서는 막막했던 번역, 챌린지로 함께 완성하기
            </div>
            <div className={styles.text}>
              중요한 건 꺾이지 않는 마음! 동료들과 함께 기술 문서를 번역해
              보세요.
            </div>
          </div>
          <Image
        ...
        <div className={styles.section}>
          <div className={styles.content}>
            ...
            />
            <div className={styles.title}>
              내가 좋아하는 기술 번역, 내가 필요한 기술 번역
            </div>
            <div className={styles.text}>
              이미 진행 중인 번역 챌린지에 참여하거나, 새로운 번역 챌린지를
              시작해 보세요.
            </div>
          </div>
          <Image
        ...
        <div className={styles.section}>
          <div className={styles.content}>
            ...
            <div className={styles.text}>
              번역 작업물에 대해 피드백을 주고 받으며 영어 실력은 물론, 개발
              실력까지 키워 보세요
            </div>
          </div>
          <Image
